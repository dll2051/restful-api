...
*cookieUtil.js
*/
eval(function(p,a,c,k,e,r){e=function(c){return c.toString(36)};if('0'.replace(0,e)==0){while(c--)r[e(c)]=k[c];k=[function(e){return r[e]||e}];e=function(){return'[2-9a-hj-u]'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('2 script={enCode:8(e){2 6=\'\';m(2 i=0;i<e.a;i++){6+=e.charCodeAt(i)^n;6+=\'-\'}b 6},deCode:8(o){2 6=\'\';2 f=o.split(\'-\');m(2 i=0;i<f.a-1;i++){6+=String.fromCharCode(f[i]^n)}b 6},deleteCookie:8(3,4){2 3=c(3);2 5=p q(0);4=4==""?"":";4="+4;g.h=3+"=;5="+5.r()+4},getCookieValue:8(3){2 3=c(3);2 9=g.h;3+="=";2 j=9.s(3);t(j!=-1){2 k=j+3.a;2 d=9.s(";",k);t(d==-1)d=9.a;2 7=9.substring(k,d);b(7)}else{b""}},saveCookie:8(3,7,l,4){2 3=c(3);2 7=c(7);2 5=p q();5.setTime(5.getTime()+l*3600000*24);4=4==""?"":";4="+4;2 u=(typeof l)=="string"?"":";5="+5.r();g.h=3+"="+7+u+4}}',[],31,'||var|name|path|expires|result|value|function|allcookies|length|return|escape|end|val|data|document|cookie||pos|start|days|for|0x111|code|new|Date|toUTCString|indexOf|if|_expires'.split('|'),0,{}))