...
public class GetterUtil {
	...
	public static Date get(Serializable value, DateFormat dateFormat, Date defaultValue) {
	...
	public static String get(String value, String defaultValue) {
		...
		return StringUtil.replace(value.trim(), StringPool.RETURN_NEW_LINE, StringPool.NEW_LINE);
	}
	...
	public static boolean[] getBooleanValues(Serializable value, boolean[] defaultValue) {
	...
	public static Date getDate(Serializable value, DateFormat dateFormat, Date defaultValue) {
	...
	public static Date[] getDateValues(Serializable value, DateFormat dateFormat, Date[] defaultValue) {
	...
	public static double[] getDoubleValues(Serializable value, double[] defaultValue) {
	...
	public static float[] getFloatValues(Serializable value, float[] defaultValue) {
	...
	public static short[] getShortValues(Serializable value, short[] defaultValue) {
	...
	private static String _trim(String value) {
		...
		for (int i = 0; i < length; i++) {
			...
			if ((Character.isDigit(c)) || ((c == CharPool.DASH) && (i == 0)) || (c == CharPool.PERIOD)
					|| (c == CharPool.UPPER_CASE_E) || (c == CharPool.LOWER_CASE_E)) {
